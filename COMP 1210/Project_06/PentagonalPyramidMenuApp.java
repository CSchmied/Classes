...
public class PentagonalPyramidMenuApp {
...
*/
   public static void main(String[] args) throws FileNotFoundException {
      ...
      System.out.println("PentagonalPyramid List System Menu\n"
                       + "R - Read in File and Create PentagonalPyramid\n"
                       + "P - Print PentagonalPyramid List\n" 
                       + "S - Print Summary\n"
                       + "A - Print Add PentagonalPyramid\n"   
                       + "D - Print Delete PentagonalPyramid\n"   
      ...
      do { 
         ...
         switch(codeChar) {
            ...
            case 'S': //Prints summary 
               System.out.println(myPList.summaryInfo()); 
               break; 
