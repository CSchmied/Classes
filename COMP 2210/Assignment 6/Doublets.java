...
public class Doublets implements WordLadderGame {
  ...
  /** 
  * Returns a min-length word ladder from start to end. 
  **/
   ...
   private ArrayList<String> bfs(String start, String end) {
      ...
      return backwards;
                        ...
                        /** 
                        * Returns all the words that have a Hamming distance.
                        **/ 
   ...
   public int getWordCount() {
      return lexicon.size(); 
                                    ...
                                    /** 
                                    * Sees if given string is a word.
                                    **/ 
   public boolean isWord(String str) {
      ...
      return false;
                                          ...
                                          /** 
                                          * Sees if the sequence given is in a valid word ladder. 
                                          **/ 
