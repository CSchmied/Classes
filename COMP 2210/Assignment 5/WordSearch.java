...
/** The implementing class for developed for WordSearchGame. 
...
/** 
* Loads lexicon into data structure.
**/
...
/** 
Stores incoming array of Strings that helps find words. 
**/ 
   public void setBoard(String[] letterArray) {
      if (letterArray == null) {
         throw new IllegalArgumentException();
      }
      int c = (int)Math.sqrt(letterArray.length);
      if ((c * c) != letterArray.length) {
         throw new IllegalArgumentException(); 
      }
      board = new String[c][c];
      width = c;
      height = c;
      int index = 0; 
...
/** 
* Retrieves all valid words on the board. 
**/ 
...
/** 
* Computes the cummulative score for the scoarable words. 
**/ 
...
/** 
* Determines if the word is in the lexicon. 
**/
...
/** 
* Determines if the is at least one word in the lexicon with the given prefix. 
**/
...
/** 
* Determines if the word is on the board. 
**/ 
